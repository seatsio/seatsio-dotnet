...
namespace SeatsioDotNet.Test.EventReports
{
    public class EventReportsSummaryTest : SeatsioClientTest
    {
        ...
        public void SummaryByStatus()
        {
            ...
            Assert.Equal(new Dictionary<string, int> {{NotAvailable, 1}}, report[Booked].byAvailability);
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 231}}, report[Free].byAvailability);
        ...
        public void SummaryByObjectType()
        {
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 32}}, report["seat"].byAvailability);
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 200}}, report["generalAdmission"].byAvailability);
        ...
        public void SummaryByCategoryKey()
        {
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 115}, {NotAvailable, 1}}, report["9"].byAvailability);
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 116}}, report["10"].byAvailability);
        ...
        public void SummaryByCategoryLabel()
        {
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 115}, {NotAvailable, 1}}, report["Cat1"].byAvailability);
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 116}}, report["Cat2"].byAvailability);
        ...
        public void SummaryBySection()
        {
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 231}, {NotAvailable, 1}}, report[NoSection].byAvailability);
        ...
        public void SummaryByAvailability()
        {
            ...
            Assert.Equal(new Dictionary<string, int> {{NoSection, 1}}, report[NotAvailable].bySection);
            Assert.Equal(new Dictionary<string, int> {{Booked, 1}}, report[NotAvailable].byStatus);
        ...
        public void SummaryByChannel()
        {
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 230}}, report[NoChannel].byAvailability);
            ...
            Assert.Equal(new Dictionary<string, int> {{Available, 2}}, report["channelKey1"].byAvailability);
        }
    }
}